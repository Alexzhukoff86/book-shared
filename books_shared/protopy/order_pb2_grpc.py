...
class OrderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DeleteAllOrders = channel.unary_unary(
...
class OrderServiceServicer(object):
    ...
    def DeleteAllOrders(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_OrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DeleteAllOrders': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteAllOrders,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
...
class OrderService(object):
    ...
    def DeleteAllOrders(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/OrderService/DeleteAllOrders',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
